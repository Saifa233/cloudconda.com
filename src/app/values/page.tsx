...
return (
    <div className="relative w-full h-full bg-black overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col gap-4 bg-white/60 w-[90%] xl:w-3/4 mx-auto rounded-4xl mt-20">
            <h2 className="text-4xl text-black uppercase font-bold text-center tracking-tighter mt-10">Core Values</h2>
            <div className="flex flex-col xl:flex-row pb-20">
                <p className="text-2xl font-medium text-black mt-10 max-w-[90%] xl:max-w-5xl pl-24">
                ...
                <img alt="cloud-icon" className="w-40 h-40 mx-auto xl:mx-20 mt-10" src="https://img.icons8.com/?size=100&id=iNYXj5zCcfyA&format=png&color=000000"></img>
            </div>
        </div>
        <div className="flex flex-col xl:flex-row gap-8 justify-center items-center mt-20">
            <div className="relative z-10 bg-white/60 w-[90%] xl:w-1/3 rounded-4xl pb-40">
                <h2 className="text-black text-3xl font-bold tracking-tighter mt-10 text-center uppercase">Innovative Thinking</h2>
            ...
            <div className="relative z-10 bg-white/60 w-[90%] xl:w-1/3 rounded-4xl pb-40">
                <h2 className="text-black text-3xl font-bold tracking-tighter mt-10 text-center uppercase">Ownership Mindset</h2>
        ...
        <div className="flex flex-col xl:flex-row gap-8 justify-center items-center mt-20 mb-40">
            <div className="relative z-10 bg-white/60 w-[90%] xl:w-1/3 rounded-4xl pb-40">
                <h2 className="text-black text-3xl font-bold tracking-tighter mt-10 text-center uppercase">Value Creation</h2>
            ...
            <div className="relative z-10 bg-white/60 w-[90%] xl:w-1/3 rounded-4xl pb-48">
                <h2 className="text-black text-3xl font-bold tracking-tighter mt-10 text-center uppercase">Learning Attitude</h2>
