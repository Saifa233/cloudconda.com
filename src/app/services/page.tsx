...
return (
    <div className="relative w-full h-full bg-black overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col gap-4 bg-white/60 w-[90%] xl:w-3/4 rounded-4xl mt-20 mx-auto">
            <h2 className="text-2xl md:text-4xl text-black uppercase font-bold text-center tracking-tighter mt-10">Our Services</h2>
            <div className="flex flex-col xl:flex-row pb-20">
                <p className="text-xl md:text-2xl font-medium text-black mt-10 max-w-[90%] 2xl:maw-w-5xl mx-auto xl:pl-24">Provision of high quality services and innovation techniques via our digital proficient. From concept to digitizing, we fortify your concerns ensuring the prime transformation of your organization. Keeping in regards your minute details, Cloud Conda bring forth the Data based digital strategy that goes orderly with your business objectives and optimize. We believe that success finds its way with persistent focus on learning and partner shipping.</p>
                <img alt="cloud-icon" className="w-20 h-20 lg:w-40 lg:h-40 mx-auto xl:mx-20 mt-10" src="https://img.icons8.com/?size=100&id=QHsDIblhqhg9&format=png&color=000000"></img>
            </div>
        </div>
        ...
        <div className="flex flex-col xl:flex-row gap-12 justify-center items-center">
            <div className="relative z-10 bg-white/60 w-[90%] xl:w-[35%] 2xl:w-[30%] rounded-4xl mt-20 pb-20">
                <h2 className="text-black text-2xl md:text-3xl font-bold tracking-tighter mt-10 text-center uppercase">IT Consultation</h2>
            ...
            <div className="relative z-10 bg-white/60 w-[90%] xl:w-[35%] 2xl:w-[30%] rounded-4xl xl:mt-20 pb-20">
                <h2 className="text-black text-2xl md:text-3xl font-bold tracking-tighter mt-10 text-center uppercase">Cloud Services</h2>
        ...
        <div className="flex flex-col xl:flex-row gap-12 justify-center items-center">
            <div className="relative z-10 bg-white/60 w-[90%] xl:w-[35%] 2xl:w-[30%] rounded-4xl mt-20 pb-20">
                <h2 className="text-black text-2xl md:text-3xl font-bold tracking-tighter mt-10 text-center uppercase">Amazon Web Services</h2>
            ...
            <div className="relative z-10 bg-white/60 w-[90%] xl:w-[35%] 2xl:w-[30%] rounded-4xl xl:mt-20 pb-20">
                <h2 className="text-black text-2xl md:text-3xl font-bold tracking-tighter mt-10 text-center uppercase">Accountability</h2>
